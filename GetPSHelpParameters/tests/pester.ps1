...
Remove-Module GetPSHelpParameters -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\GetPSHelpParameters.psd1"
Import-Module "$PSScriptRoot\..\GetPSHelpParameters.psm1" -Force
